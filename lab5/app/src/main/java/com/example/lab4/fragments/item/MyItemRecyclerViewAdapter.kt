package com.example.lab4.fragments.item
...
import com.example.lab4.fragments.item.ItemFragment.OnListFragmentInteractionListener
...
class MyItemRecyclerViewAdapter(
    ...
    init {
        mOnClickListener = View.OnClickListener { v ->
            ...
            item.second.date = item.first
            mListener?.onListFragmentInteraction(item.second)
        }
    }
